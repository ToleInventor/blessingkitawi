...
function createEventCard(id, event, type) {
    const listElement = type === 'normal' 
        ? document.getElementById('normal-events-list') 
        : document.getElementById('special-events-list');
    ...
    if (type === 'normal') {
        detailsHTML = `
            <div class="event-details">
                ...
                <p><strong>Time:</strong> ${event.time} (Delay: ${event.delay}s)</p>
...
document.addEventListener('DOMContentLoaded', () => {
    renderEvents();
    setInterval(updateEsp32Collection, 60000);
    setInterval(checkPastSpecialEvents, 3600000);
});
